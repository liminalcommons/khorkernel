...
# Note: Updated import path for the renamed package
...
class KhoraConfigAccessor:
    ...
    def active_environment(self) -> Optional[str]:
        """
        Get the active environment used for configuration if any.
        
        Returns:
            The name of the active environment, or None if no environment is active
        """
