...
def get_extension_template(
    ...
    Args:
        ...
        extension_module: Optional module path for the extension, defaults to
                         khora_kernel.extensions.<extension_name>
    ...
    if relative_to is None:
        relative_to = f"khora_kernel.extensions.{extension_name}.templates"
...
class TemplateManager:
    ...
    def __init__(self, extension_name: str, template_dir: Optional[str] = None):
        ...
        self.template_module = f"khora_kernel.extensions.{extension_name}"
    ...
    def render_pyscaffold_template(self, template_content, context: Dict[str, Any]) -> str:
        ...
        It also handles string.Template objects properly.
    ...
    def get_all_templates(self) -> Dict[str, str]:
        ...
        try:
            ...
            package_path = Path(__file__).parent.parent  # khora_kernel directory
